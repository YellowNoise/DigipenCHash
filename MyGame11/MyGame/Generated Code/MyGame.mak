...
LINK32_OBJS= \
	"$(INTDIR)\MyGame_ArrowClass.obj" \
	"$(INTDIR)\MyGame_ArrowLRClass.obj" \
...
SOURCE=.\MyGame_ArrowClass.cpp

"$(INTDIR)\MyGame_ArrowClass.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_ArrowLRClass.cpp

"$(INTDIR)\MyGame_ArrowLRClass.obj" : $(SOURCE) "$(INTDIR)"
