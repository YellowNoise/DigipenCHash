...
void CollisionActor02(MyLevelFactory *mlf)
{
	...
	collisionFrame->AddCollisionData(Point2D(-78.0,22.0),Point2D(77.0,22.0),0,true);
	collisionFrame->AddCollisionData(Point2D(-78.0,-22.0),Point2D(-78.0,22.0),0,true);
	collisionFrame->AddCollisionData(Point2D(77.0,22.0),Point2D(77.0,-22.0),0,true);
	collisionFrame->AddCollisionData(Point2D(77.0,-22.0),Point2D(-78.0,-22.0),0,true);
	collisionAnimation->AddCollisionFrame(collisionFrame);
