...
Level * MyLevelFactory::CreateLevel0()
{
	...
	camera0_141_Camera = new Camera(45.0f);
	camera0_141_Camera->SetName("camera0");
	camera0_141_Camera->SetPosition(Point2D(0.0f,0.0f));
	layer2_Layer->AddGameObject(camera0_141_Camera);


	Viewport0_Viewport = new Viewport(0, 0, 800, 600);
	Viewport0_Viewport->SetClearColor(Color(0.2509804f ,0.2509804f ,0.2509804f));
	Viewport0_Viewport->SetCamera(camera0_141_Camera);
