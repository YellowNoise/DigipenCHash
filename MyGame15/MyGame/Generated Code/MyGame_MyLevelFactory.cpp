...
Level * MyLevelFactory::CreateLevel0()
{
	...
	layer2_Layer = new Layer(724.2641f);
	...
	camera0_143_Camera = new Camera(45.0f);
	camera0_143_Camera->SetName("camera0");
	camera0_143_Camera->SetPosition(Point2D(0.0f,0.0f));
	layer2_Layer->AddGameObject(camera0_143_Camera);


	Viewport0_Viewport = new Viewport(0, 0, 800, 600);
	Viewport0_Viewport->SetClearColor(Color(0.2509804f ,0.2509804f ,0.2509804f));
	Viewport0_Viewport->SetCamera(camera0_143_Camera);
...
//LEVEL0
	...
	//Sprites
	ball_144_BallClass = 0;

	//ParticleSystems

	//Cameras
	camera0_143_Camera = 0;
