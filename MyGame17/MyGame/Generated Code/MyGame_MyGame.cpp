...
bool MyGame:: GetImpactProperties_Level0(ProjectFun::GameObject * object1,ProjectFun::GameObject * object2,float& bounciness,float& friction)
{
	if(object2 != NULL)//object1 vs object2
	{
		...
		//CollisionAffections
		if((object1->GetName() == "paddle") && (object2->GetName() == "bluball")){
			return false;
		}
 else if((object1->GetName() == "bluball") && (object2->GetName() == "paddle")){
			m_OneWayCollision = true;
			return true;
		}	if((object1->GetName() == "paddle") && (object2->GetName() == "redball")){
			return false;
		}
 else if((object1->GetName() == "redball") && (object2->GetName() == "paddle")){
			m_OneWayCollision = true;
			return true;
		}
	}
