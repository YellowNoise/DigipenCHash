...
Level * MyLevelFactory::CreateLevel0()
{
	...
	camera0_151_Camera = new Camera(45.0f);
	camera0_151_Camera->SetName("camera0");
	camera0_151_Camera->SetPosition(Point2D(0.0f,0.0f));
	layer2_Layer->AddGameObject(camera0_151_Camera);


	Viewport0_Viewport = new Viewport(0, 0, 800, 600);
	Viewport0_Viewport->SetClearColor(Color(0.2509804f ,0.2509804f ,0.2509804f));
	Viewport0_Viewport->SetCamera(camera0_151_Camera);
...
//LEVEL0
	...
	//Sprites
	paddle_152_Sprite = 0;
	bluball_153_Sprite = 0;
	redball_154_Sprite = 0;

	//ParticleSystems

	//Cameras
	camera0_151_Camera = 0;
