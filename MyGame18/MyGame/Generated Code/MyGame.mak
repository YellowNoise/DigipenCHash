...
LINK32_OBJS= \
	"$(INTDIR)\MyGame_BallClass.obj" \
	"$(INTDIR)\MyGame_BulletClass.obj" \
	"$(INTDIR)\MyGame_CollisionActors0.obj" \
	"$(INTDIR)\MyGame_Level0Objects.obj" \
	"$(INTDIR)\MyGame_Level_Class0.obj" \
...
SOURCE=.\MyGame_BallClass.cpp

"$(INTDIR)\MyGame_BallClass.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_BulletClass.cpp

"$(INTDIR)\MyGame_BulletClass.obj" : $(SOURCE) "$(INTDIR)"
...
SOURCE=.\MyGame_Level_Class0.cpp

"$(INTDIR)\MyGame_Level_Class0.obj" : $(SOURCE) "$(INTDIR)"
