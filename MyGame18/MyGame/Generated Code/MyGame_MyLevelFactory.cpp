...
Level * MyLevelFactory::CreateLevel0()
{
	...
	layer1_Layer->SetCollisionProperties(Math::Point2D(-1008,-300),1408,632);
	...
	camera0_155_Camera = new Camera(45.0f);
	camera0_155_Camera->SetName("camera0");
	camera0_155_Camera->SetPosition(Point2D(0.0f,0.0f));
	layer2_Layer->AddGameObject(camera0_155_Camera);


	Viewport0_Viewport = new Viewport(0, 0, 800, 600);
	Viewport0_Viewport->SetClearColor(Color(0.2509804f ,0.2509804f ,0.2509804f));
	Viewport0_Viewport->SetCamera(camera0_155_Camera);
...
//LEVEL0
	...
	//Sprites
	Bullet_156_BulletClass = 0;
	ball_157_BallClass = 0;

	//ParticleSystems

	//Cameras
	camera0_155_Camera = 0;
