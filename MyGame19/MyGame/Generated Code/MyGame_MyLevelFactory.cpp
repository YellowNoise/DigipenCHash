...
Level * MyLevelFactory::CreateLevel0()
{
	...
	camera0_158_Camera = new Camera(45.0f);
	camera0_158_Camera->SetName("camera0");
	camera0_158_Camera->SetPosition(Point2D(0.0f,0.0f));
	layer2_Layer->AddGameObject(camera0_158_Camera);


	Viewport0_Viewport = new Viewport(0, 0, 800, 600);
	Viewport0_Viewport->SetClearColor(Color(0.2509804f ,0.2509804f ,0.2509804f));
	Viewport0_Viewport->SetCamera(camera0_158_Camera);
...
//LEVEL0
	...
	//Sprites
	player_159_PlayerClass = 0;
	sprite1_160_EnemyClass = 0;

	//ParticleSystems

	//Cameras
	camera0_158_Camera = 0;
