...
LINK32_OBJS= \
	...
	"$(INTDIR)\MyGame_ExplodeLevelClass.obj" \
	...
	"$(INTDIR)\MyGame_Sprite_Class0.obj" \
	"$(INTDIR)\MyGame.res"
...
SOURCE=.\MyGame_ExplodeLevelClass.cpp

"$(INTDIR)\MyGame_ExplodeLevelClass.obj" : $(SOURCE) "$(INTDIR)"
...
SOURCE=.\MyGame_Sprite_Class0.cpp

"$(INTDIR)\MyGame_Sprite_Class0.obj" : $(SOURCE) "$(INTDIR)"
