...
{
	level0_Level = new ExplodeLevelClass();
	...
	layer1_Layer->SetCollisionProperties(Math::Point2D(-685,-300),1085,600);
	...
	camera0_161_Camera = new Camera(45.0f);
	camera0_161_Camera->SetName("camera0");
	camera0_161_Camera->SetPosition(Point2D(0.0f,0.0f));
	layer2_Layer->AddGameObject(camera0_161_Camera);


	Viewport0_Viewport = new Viewport(0, 0, 800, 600);
	Viewport0_Viewport->SetClearColor(Color(0.2509804f ,0.2509804f ,0.2509804f));
	Viewport0_Viewport->SetCamera(camera0_161_Camera);
...
//LEVEL0
	...
	//Sprites
	sprite0_164_Sprite_Class0 = 0;

	//ParticleSystems
	particleSystem0_162_ParticleSystem = 0;
	particleSystem1_165_ParticleSystem = 0;
	particleSystem2_166_ParticleSystem = 0;
	glow_167_ParticleSystem = 0;

	//Cameras
	camera0_161_Camera = 0;
...
{
	sprite0_164_Sprite_Class0->Mount(particleSystem2_166_ParticleSystem);
