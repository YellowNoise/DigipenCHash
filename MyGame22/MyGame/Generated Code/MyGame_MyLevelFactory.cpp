...
Level * MyLevelFactory::CreateLevel0()
{
	...
	layer1_Layer->SetCollisionProperties(Math::Point2D(-400,-300),1600,600);
	...
	camera0_7_Camera = new Camera(45.0f);
	camera0_7_Camera->SetName("camera0");
	camera0_7_Camera->SetPosition(Point2D(0.0f,0.0f));
	layer2_Layer->AddGameObject(camera0_7_Camera);


	Viewport0_Viewport = new Viewport(0, 0, 800, 600);
	Viewport0_Viewport->SetClearColor(Color(0.2509804f ,0.2509804f ,0.2509804f));
	Viewport0_Viewport->SetCamera(camera0_7_Camera);
...
//LEVEL0
	...
	//Sprites
	bg_8_ScrollBGClass = 0;
	bg_9_ScrollBGClass = 0;
