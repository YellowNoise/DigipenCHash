...
LINK32_OBJS= \
	...
	"$(INTDIR)\MyGame_PaddleClass.obj" \
	"$(INTDIR)\MyGame_PaddleClass_Movement_Functions_StateMachine.obj" \
	"$(INTDIR)\MyGame_PaddleClass_Movement_StateMachine.obj" \
	"$(INTDIR)\MyGame.res"
...
SOURCE=.\MyGame_PaddleClass.cpp

"$(INTDIR)\MyGame_PaddleClass.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_PaddleClass_Movement_Functions_StateMachine.cpp

"$(INTDIR)\MyGame_PaddleClass_Movement_Functions_StateMachine.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_PaddleClass_Movement_StateMachine.cpp

"$(INTDIR)\MyGame_PaddleClass_Movement_StateMachine.obj" : $(SOURCE) "$(INTDIR)"
