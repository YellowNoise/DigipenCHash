...
LINK32_OBJS= \
	"$(INTDIR)\MyGame_AngelClass.obj" \
	"$(INTDIR)\MyGame_AngelClass_sm1_Functions_StateMachine.obj" \
	"$(INTDIR)\MyGame_AngelClass_sm1_StateMachine.obj" \
	"$(INTDIR)\MyGame_Camera_Class0.obj" \
	"$(INTDIR)\MyGame_CollisionActors0.obj" \
	"$(INTDIR)\MyGame_CollisionActors1.obj" \
	"$(INTDIR)\MyGame_CursorClass.obj" \
	"$(INTDIR)\MyGame_EnemyClass1.obj" \
	"$(INTDIR)\MyGame_EnemyClass1_sm1_Functions_StateMachine.obj" \
	"$(INTDIR)\MyGame_EnemyClass1_sm1_StateMachine.obj" \
	"$(INTDIR)\MyGame_EnemyClass2.obj" \
	"$(INTDIR)\MyGame_EnemyClass2_sm1_Functions_StateMachine.obj" \
	"$(INTDIR)\MyGame_EnemyClass2_sm1_StateMachine.obj" \
	"$(INTDIR)\MyGame_Level0Objects.obj" \
	"$(INTDIR)\MyGame_Level1Objects.obj" \
	"$(INTDIR)\MyGame_Level2Objects.obj" \
	"$(INTDIR)\MyGame_Level3Objects.obj" \
	"$(INTDIR)\MyGame_Level4Objects.obj" \
	"$(INTDIR)\MyGame_MainDeclarations.obj" \
	"$(INTDIR)\MyGame_MyGame.obj" \
	"$(INTDIR)\MyGame_MyGame_gamesm_Functions_StateMachine.obj" \
	"$(INTDIR)\MyGame_MyGame_gamesm_StateMachine.obj" \
	...
	"$(INTDIR)\MyGame_MyLevelFactory_1_0.obj" \
	"$(INTDIR)\MyGame_MyLevelFactory_1_1.obj" \
	"$(INTDIR)\MyGame_MyLevelFactory_1_2.obj" \
	"$(INTDIR)\MyGame_MyLevelFactory_2_0.obj" \
	"$(INTDIR)\MyGame_MyLevelFactory_2_1.obj" \
	"$(INTDIR)\MyGame_MyLevelFactory_2_2.obj" \
	"$(INTDIR)\MyGame_MyLevelFactory_3_0.obj" \
	"$(INTDIR)\MyGame_MyLevelFactory_3_1.obj" \
	"$(INTDIR)\MyGame_MyLevelFactory_3_2.obj" \
	"$(INTDIR)\MyGame_MyLevelFactory_4_0.obj" \
	"$(INTDIR)\MyGame_MyLevelFactory_4_1.obj" \
	"$(INTDIR)\MyGame_MyLevelFactory_4_2.obj" \
	"$(INTDIR)\MyGame_RingClass.obj" \
	"$(INTDIR)\MyGame_SoggyClass.obj" \
	"$(INTDIR)\MyGame_SoggyClass_animationsm_Functions_StateMachine.obj" \
	"$(INTDIR)\MyGame_SoggyClass_animationsm_StateMachine.obj" \
	"$(INTDIR)\MyGame_SoggyClass_PlatformSM_Functions_StateMachine.obj" \
	"$(INTDIR)\MyGame_SoggyClass_PlatformSM_StateMachine.obj" \
	"$(INTDIR)\MyGame.res"
...
SOURCE=.\MyGame_AngelClass.cpp

"$(INTDIR)\MyGame_AngelClass.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_AngelClass_sm1_Functions_StateMachine.cpp

"$(INTDIR)\MyGame_AngelClass_sm1_Functions_StateMachine.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_AngelClass_sm1_StateMachine.cpp

"$(INTDIR)\MyGame_AngelClass_sm1_StateMachine.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_Camera_Class0.cpp

"$(INTDIR)\MyGame_Camera_Class0.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_CollisionActors0.cpp

"$(INTDIR)\MyGame_CollisionActors0.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_CollisionActors1.cpp

"$(INTDIR)\MyGame_CollisionActors1.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_CursorClass.cpp

"$(INTDIR)\MyGame_CursorClass.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_EnemyClass1.cpp

"$(INTDIR)\MyGame_EnemyClass1.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_EnemyClass1_sm1_Functions_StateMachine.cpp

"$(INTDIR)\MyGame_EnemyClass1_sm1_Functions_StateMachine.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_EnemyClass1_sm1_StateMachine.cpp

"$(INTDIR)\MyGame_EnemyClass1_sm1_StateMachine.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_EnemyClass2.cpp

"$(INTDIR)\MyGame_EnemyClass2.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_EnemyClass2_sm1_Functions_StateMachine.cpp

"$(INTDIR)\MyGame_EnemyClass2_sm1_Functions_StateMachine.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_EnemyClass2_sm1_StateMachine.cpp

"$(INTDIR)\MyGame_EnemyClass2_sm1_StateMachine.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_Level0Objects.cpp

"$(INTDIR)\MyGame_Level0Objects.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_Level1Objects.cpp

"$(INTDIR)\MyGame_Level1Objects.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_Level2Objects.cpp

"$(INTDIR)\MyGame_Level2Objects.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_Level3Objects.cpp

"$(INTDIR)\MyGame_Level3Objects.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_Level4Objects.cpp

"$(INTDIR)\MyGame_Level4Objects.obj" : $(SOURCE) "$(INTDIR)"
...
SOURCE=.\MyGame_MyGame_gamesm_Functions_StateMachine.cpp

"$(INTDIR)\MyGame_MyGame_gamesm_Functions_StateMachine.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyGame_gamesm_StateMachine.cpp

"$(INTDIR)\MyGame_MyGame_gamesm_StateMachine.obj" : $(SOURCE) "$(INTDIR)"
...
SOURCE=.\MyGame_MyLevelFactory_1_0.cpp

"$(INTDIR)\MyGame_MyLevelFactory_1_0.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyLevelFactory_1_1.cpp

"$(INTDIR)\MyGame_MyLevelFactory_1_1.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyLevelFactory_1_2.cpp

"$(INTDIR)\MyGame_MyLevelFactory_1_2.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyLevelFactory_2_0.cpp

"$(INTDIR)\MyGame_MyLevelFactory_2_0.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyLevelFactory_2_1.cpp

"$(INTDIR)\MyGame_MyLevelFactory_2_1.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyLevelFactory_2_2.cpp

"$(INTDIR)\MyGame_MyLevelFactory_2_2.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyLevelFactory_3_0.cpp

"$(INTDIR)\MyGame_MyLevelFactory_3_0.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyLevelFactory_3_1.cpp

"$(INTDIR)\MyGame_MyLevelFactory_3_1.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyLevelFactory_3_2.cpp

"$(INTDIR)\MyGame_MyLevelFactory_3_2.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyLevelFactory_4_0.cpp

"$(INTDIR)\MyGame_MyLevelFactory_4_0.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyLevelFactory_4_1.cpp

"$(INTDIR)\MyGame_MyLevelFactory_4_1.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_MyLevelFactory_4_2.cpp

"$(INTDIR)\MyGame_MyLevelFactory_4_2.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_RingClass.cpp

"$(INTDIR)\MyGame_RingClass.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_SoggyClass.cpp

"$(INTDIR)\MyGame_SoggyClass.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_SoggyClass_animationsm_Functions_StateMachine.cpp

"$(INTDIR)\MyGame_SoggyClass_animationsm_Functions_StateMachine.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_SoggyClass_animationsm_StateMachine.cpp

"$(INTDIR)\MyGame_SoggyClass_animationsm_StateMachine.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_SoggyClass_PlatformSM_Functions_StateMachine.cpp

"$(INTDIR)\MyGame_SoggyClass_PlatformSM_Functions_StateMachine.obj" : $(SOURCE) "$(INTDIR)"

SOURCE=.\MyGame_SoggyClass_PlatformSM_StateMachine.cpp

"$(INTDIR)\MyGame_SoggyClass_PlatformSM_StateMachine.obj" : $(SOURCE) "$(INTDIR)"
